...
router.get("/", verifyLogin, async (req, res) => {
    ...
    if (token === null) view = render("error/servererror", { code: 500, message: "error getting the API token" });
        ...
        if (user === null) view = render("error/servererror", { code: 500, message: "error recovering the data of the user " + req.session.userId });
            ...
            if (user.ativo) {
                imports = render("base/css-import", { link: "/static/css/pages/user" }) + render("base/css-import", { link: "/static/css/component/modal" });
                ...
                imports = render("base/css-import", { link: "/static/css/pages/no-curriculum" }) + render("base/css-import", { link: "/static/css/component/modal" });
...
router.get("/curriculo/novo", verifyLogin, userNotActive, (req, res) => {
    let view = "";
    let imports = render("base/css-import", { link: "/static/css/pages/candidate" }) + render("base/css-import", { link: "/static/css/pages/contact" });
...
router.get("/curriculo/habilidades", verifyLogin, async (req, res) => {
    ...
    if (token === null) view = render("error/servererror", { code: 500, message: "error getting the API login token" });
        ...
        view = render("base/page", {
            ...
            imports: render("base/css-import", { link: "/static/css/pages/hability" }) + render("base/css-import", { link: "/static/css/component/table" }) + render("base/css-import", { link: "/static/css/component/modal" }),
            header: render("user/base/header"),
...
router.get("/curriculo/contatos", verifyLogin, async (req, res) => {
    ...
    if (token === null) view = render("error/servererror", { code: 500, message: "error getting the API login token" });
        ...
        view = render("base/page", {
            ...
            imports: render("base/css-import", { link: "/static/css/pages/contact" }),
            header: render("user/base/header"),
